...
const INTER_THOUGHT_WAIT_TIME = 2000;
const POST_ACTION_WAIT_TIME = 5000;
...
function App() {
  ...
  function pushToDB(idsToUpdate: Set<string>) {
    ...
    idsToUpdate.forEach(async (id) => {
      ...
      if (foundNode === null || foundNodePos === null) {
        ...
        console.log("thoughID: ", id);
        console.log("marks: ", marks);
        console.log("meatadata: ", foundNode.attrs.metadata);
  ...
  useEffect(() => {
    if (generatingLoopOn) {
      console.log("in generationTrigger useEffect");
      generateThought();
    }
